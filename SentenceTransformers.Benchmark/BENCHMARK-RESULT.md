...
| Model        | Dim  | Batch | ms/iter  | Emb/s | In B/s  | Out B/s | WS Δ (bytes) | GC Δ (bytes) |
| ------------ | ---- | ----- | -------- | ----- | ------- | ------- | ------------ | ------------ |
| MiniLM-L6-v2 | 384  | 8     | 80.88    | 98.91 | 190,756 | 151,932 | 136,495,104  | 6,094,944    |
| ArcticXs     | 384  | 8     | 114.54   | 69.85 | 134,699 | 107,284 | 71,172,096   | 3,040,536    |
| Qwen3-0.6B   | 1024 | 8     | 1,357.74 | 5.89  | 11,363  | 24,134  | 152,567,808  | 7,689,352    |
