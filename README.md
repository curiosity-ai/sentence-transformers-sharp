...
scales would otherwise force every 128 weights. `QUANTIZATION.md` has the full account, including why
the single-thread lead is bounded near 1.18× and why the multi-thread one is larger.
